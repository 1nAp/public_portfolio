...
class FlightSearch:
    ...
    def get_destination_code(self, city_name):
        """Searches for the Airport IATA code for a given city, using the Amadeus API.
        Parameters:
            city_name (str): The name of a city in the Google Sheet."""
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, is_direct=True):
        ...
        Parameters:
            ...
            is_direct (str): Whether it's a direct flight or not.
        Returns:
        ...
        #print(f"Using this token to check_flights() {self._token}") - for testing purposes only.
        headers = {"Authorization": f"Bearer {self._token}"}
        query = {
